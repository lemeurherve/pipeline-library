            ...
            if (isBuildOnChangeRequest) {
              ...
              stage('💸 Report estimated costs') {
                try {
                  ...
                  // On AWS we can use the terraform plan to estimate the costs as it doesn't contains the most sensible secrets like AWS
                  ...
                  if (commentReport) {
                    ...
                    sh 'export INFRACOST_REPORT=$(cat github.com)'
